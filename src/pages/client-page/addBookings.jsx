...
//     useEffect(()=>{
//         if(!isLoadeing){
//             axios.get(import.meta.env.VITE_BACKEND_URL + '/api/category/' + 'all-categories').then((result)=>{
...
//         console.log(`Cat value is ${cat}`);
    
//         axios
//             .get(import.meta.env.VITE_BACKEND_URL + '/api/room/all-roomids/' + cat) // Corrected the URL structure
//             .then((response) => {
//                 // Accessing the data property of the response
//                 const val = response.data.Room_numbers;
//                 setRoomNumbers(val);
//                 console.log(`Num list is ${JSON.stringify(val)}`); // Convert to JSON string for readable output
//             })
//             .catch((err) => {
...
//                         <h2 className="text-xl font-semibold text-gray-700 mb-4">New Booking</h2>
...
//                     <div>
//                         <h2 className="text-xl font-semibold text-gray-700 mb-4">Existing Bookings</h2>
...
//                                         <td className="px-4 py-2 border">example@example.com</td>
